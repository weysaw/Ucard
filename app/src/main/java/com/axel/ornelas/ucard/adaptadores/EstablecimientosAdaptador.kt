...
class EstablecimientosAdaptador(private val establecimientos: ArrayList<Establecimiento>) :
    RecyclerView.Adapter<EstablecimientosAdaptador.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tipo.text = establecimiento.nombre
        Glide.with(contexto).load(establecimiento.logo).centerCrop().into(holder.imagen)
    }
